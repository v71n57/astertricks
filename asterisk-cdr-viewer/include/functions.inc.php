...
//	$recorded_file = glob($system_monitor_dir . '/' . $row['src'] . '*' . $row['uniqueid'] . '.' . $system_audio_format);
	...
	*/
	...
	if (file_exists("$system_monitor_dir/$recorded_file.$system_audio_format")) {
		...
		echo "    <td class=\"record_col\"><a href=\"download.php?audio=$recorded_file.$system_audio_format\" title=\"Listen to call recording\"><img src=\"/icons/small/sound.png\" alt=\"Call recording\" /></a><audio class=\"player\" src=\"monitor/$recorded_file.$system_audio_format\"></audio></td>\n";
